import ImageOne from '../images/hape5.jpg'
import ImageTwo from '../images/hape7.jpg'
...
export const InfoDataTwo = {
    ...
    paragraphTwo: 'You can find out more about the HAPEBEAST team below and see the lightest hints for our post-release plans. As we move closer to launch this site will evolve; like apes at the dawn of a new world we’re making something from nothing, noise from silence. In the beginning was the word. The word was, and is, HAPE.',
    buttonLabel: 'View House',
    image: ImageTwo,
    reverse: true,
    delay: 300,
